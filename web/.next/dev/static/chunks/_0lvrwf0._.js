...
"[project]/app/components/RefreshDataButton.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RefreshDataButton() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RefreshDataButton.useEffect": ()=>{
            fetch(`${API}/api/admin/db-provider`).then({
                "RefreshDataButton.useEffect": (r)=>r.ok ? r.json() : null
            }["RefreshDataButton.useEffect"]).then({
                "RefreshDataButton.useEffect": (d)=>setVisible(d?.provider === "sqlite")
            }["RefreshDataButton.useEffect"]).catch({
                "RefreshDataButton.useEffect": ()=>setVisible(false)
            }["RefreshDataButton.useEffect"]);
            return ({
                "RefreshDataButton.useEffect": ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            open && status && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(RefreshDataButton, "R4aOqQUPhFYbrTInD/Z4btomiHw=");
_c = RefreshDataButton;
var _c;
__turbopack_context__.k.register(_c, "RefreshDataButton");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0lvrwf0._.js.map